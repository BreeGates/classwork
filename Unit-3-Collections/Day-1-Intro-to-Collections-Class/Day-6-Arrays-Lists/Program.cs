...
class Program
{
    static void Main(string[] args)
    {
        ...
        //since our List starts off empty we cant use .Count to control oue loop
        for (int i=0; i < 3; i++)  // i = 0, 1, 2 inside loop and 3 when exit loop
        {
            ...
            //numbers[i] = int.Parse(Console.ReadLine());    // get a string from keyboard
             numbers.Add (int.Parse(Console.ReadLine()));                                              // convert it toan int
